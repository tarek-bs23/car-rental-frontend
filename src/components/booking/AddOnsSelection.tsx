      ...
      <div className="px-4 py-6 space-y-4 max-w-md mx-auto">
        ...
        {!addDriver && (
          <button
            ...
            className="w-full bg-white rounded-xl p-4 shadow-sm border-2 border-dashed border-green-300 hover:border-green-500 hover:bg-green-50/50 transition-colors relative overflow-hidden"
          >
            {/* Discount badge */}
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 text-left">
                ...
                <p className="text-sm text-gray-600">From ${drivers[0]?.pricePerHour}/hour • Bundle discount</p>
              </div>
            </div>
          </button>
        )}
        ...
        {!addBodyguard && (
          <button
            ...
            className="w-full bg-white rounded-xl p-4 shadow-sm border-2 border-dashed border-purple-300 hover:border-purple-500 hover:bg-purple-50/50 transition-colors relative overflow-hidden"
          >
            {/* Discount badge */}
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 text-left">
                ...
                <p className="text-sm text-gray-600">From ${bodyguards[0]?.pricePerHour}/hour • Bundle discount</p>
              </div>
            </div>
          </button>
        )}
                  ...
                  <div className="flex items-center gap-2 p-2 bg-green-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-green-700">
                        {addDriver && 'Driver 10% off'}
                        {addDriver && addBodyguard && ' + '}
                        {addBodyguard && 'Security 15% off'}
                      </p>
                    </div>
